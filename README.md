...
Visit https://mybinder.org/v2/gh/bluesky/tutorial-hello-bluesky/main?urlpath=lab.
...
2. Clone this project and `cd` into the project root.
   ...
   ```
   git clone https://github.com/bluesky/tutorial-hello-bluesky
   cd tutorial-hello-bluesky
   ```
...
2. Create a software environment for running and saving changes to the
   ...
   conda create -n tutorial-hello-bluesky python=3.8
   conda activate tutorial-hello-bluesky
